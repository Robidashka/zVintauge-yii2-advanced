...
<div class="modal-container">
    ...
    <a  role="button" class="close" aria-label="close this modal">
		...
		<h2 class="modal-title center">Notifications of new posts will be sent to the email you used to register</h2>
		<?php $form = \yii\widgets\ActiveForm::begin(['action'=>['article/mailer', 'slug'=>$article->slug]])?>
      <div class="form-group">
        <div class="col-md-12">
        <?php echo "<p>" . Yii::$app->user->identity->email . "</p>";?>
        <center><?= $form->field($mailer, 'agree')->checkbox(['label' => 'I agree to receive emails about new posts'])?></center>
        </div>
      </div>
